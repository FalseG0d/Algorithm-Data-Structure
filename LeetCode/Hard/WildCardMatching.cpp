...
public:
    bool help(string& str, string& ptr, int itr1, int itr2) {
        ...
        if(itr1 == -1) {
            // Can return true if on * is left
            if(ptr[itr2] == '*') return help(str, ptr, itr1, itr2-1);
            else return false;
        }
        ...
        else if(ptr[itr2] == '*') return dp[itr1][itr2] = help(str, ptr, itr1-1, itr2-1) || help(str, ptr, itr1, itr2-1) || help(str, ptr, itr1-1, itr2);
